...
public:
	bool transmit(uint16_t devAddr, uint8_t *data, uint16_t size, uint32_t timeout = 1000);
	bool receive(uint16_t devAddr, uint8_t *data, uint16_t size, uint32_t timeout = 1000);
