...
Bme280Settings AbstractBme280::getSettings() const {
  ...
  */
  ...
  return {
      ...
      .temperatureOversampling = static_cast<Bme280Oversampling>(ctrlMeas_.osrsT),
...
void Bme280TwoWire::begin(const Bme280TwoWireAddress address, I2CMaster *wire) {
...
void Bme280TwoWire::write8(const uint8_t registerAddress, uint8_t value) {
  ...
  wire_->writeRegister(address_, registerAddress, value);
...
uint8_t Bme280TwoWire::read8(const uint8_t registerAddress) const {
  ...
  uint8_t value;
  wire_->readRegister(address_, registerAddress, &value);
  return value;
...
uint16_t Bme280TwoWire::read16(const uint8_t registerAddress) const {
  ...
  uint8_t value[2];
  wire_->readRegister(address_, registerAddress, value, 2);
...
uint32_t Bme280TwoWire::read24(const uint8_t registerAddress) const {
  ...
  uint8_t value[3];
  wire_->readRegister(address_, registerAddress, value, 3);
  return ((uint16_t)value[0] << 16) | ((uint16_t)value[1] << 8) | ((uint16_t)value[2]);
